...
namespace VOID_STORE.Views
{
    public partial class AdminEditGame : Window
    {
        ...
        {
            // secilen oyunun bilgilerini yukle
        ...
        {
        // secili oyunun kayitli verisini geri yukle
            if (_selectedGameId == 0)
            {
                return;
            }
        ...
        private void ApplyState(GameEditState state)
        {
            ...
            txtDraftStatus.Text = state.HasPendingDraft
                ? "Gönderilen değişiklikler açık"
                : "Yayındaki sürüm açık";
